...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "6741098657:AAEjM2WbfD3ljf7zCMLZZ0-JvjjFTJggZT0")
...
#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002067147890"))
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "6143946435").split()):
        ADMINS.append(int(x))
except ValueError:
